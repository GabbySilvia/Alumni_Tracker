...
<head>
    ...
    <title>Tracker Study - Login</title>
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h5 class="text-center"><b>Make Your Day Is Tracker <b></h5> </br>
                                        <img src="image.webp" class="rounded  mx-auto d-block" alt="Cinque Terre"><br>
                                        <h3 class="login-box-msg ">Tracker Study </h3>
                                        <hr>
                                        <?php
